...
def topology():
        ...
        h1 = net.addHost( 'h1', ip="192.168.0.2/29", mac="00:00:00:00:00:01")
        h2 = net.addHost( 'h2', ip="192.168.0.3/29", mac="00:00:00:00:00:02")
        h3 = net.addHost( 'h3', ip="192.168.0.4/29", mac="00:00:00:00:00:03")
        h4 = net.addHost( 'h4', ip="192.168.0.5/29", mac="00:00:00:00:00:04")

        h5 = net.addHost( 'h5', ip="172.16.0.2/29", mac="00:00:00:00:00:05")
        h6 = net.addHost( 'h6', ip="172.16.0.3/29", mac="00:00:00:00:00:06")
        h7 = net.addHost( 'h7', ip="172.16.0.4/29", mac="00:00:00:00:00:07")
        h8 = net.addHost( 'h8', ip="172.16.0.5/29", mac="00:00:00:00:00:08")

        h9 =  net.addHost(  'h9',  ip="10.0.0.2/29",  mac="00:00:00:00:00:10")        
        h10 = net.addHost( 'h10', ip="10.0.0.3/29",   mac="00:00:00:00:00:11")
        h11 = net.addHost( 'h11', ip="10.0.0.4/29",   mac="00:00:00:00:00:12")
        h12 = net.addHost( 'h12', ip="10.0.0.5/29",   mac="00:00:00:00:00:13")
       

        r1 = net.addHost( 'r1') #adding the router here
        ...
        r1.cmd("ip addr add 192.168.0.1/29 brd + dev r1-eth0")
        r1.cmd("ip addr add 172.16.0.1/29 brd + dev r1-eth1")
        r1.cmd("ip addr add 10.0.0.1/29 brd + dev r1-eth2")

        r1.cmd("echo 1 > /proc/sys/net/ipv4/ip_forward")
        
        h1.cmd("ip route add default via 192.168.0.1")
        h2.cmd("ip route add default via 192.168.0.1")
        h3.cmd("ip route add default via 192.168.0.1")
        h4.cmd("ip route add default via 192.168.0.1")

        h5.cmd("ip route add default via 172.16.0.1")
        h6.cmd("ip route add default via 172.16.0.1")
        h7.cmd("ip route add default via 172.16.0.1")
        h8.cmd("ip route add default via 172.16.0.1")

        h9.cmd("ip route add default via  10.0.0.1")
        h10.cmd("ip route add default via 10.0.0.1")
        h11.cmd("ip route add default via 10.0.0.1")
        h12.cmd("ip route add default via 10.0.0.1")
