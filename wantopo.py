...
def topology():
        ...
        h3 = net.addHost( 'h3', ip="10.0.1.4/24", mac="00:00:00:00:00:03")
        h4 = net.addHost( 'h4', ip="10.0.1.5/24", mac="00:00:00:00:00:04")

        h5 = net.addHost( 'h5', ip="10.0.2.2/24", mac="00:00:00:00:00:05")
        h6 = net.addHost( 'h6', ip="10.0.2.3/24", mac="00:00:00:00:00:06")
        h7 = net.addHost( 'h7', ip="10.0.2.4/24", mac="00:00:00:00:00:07")
        h8 = net.addHost( 'h8', ip="10.0.2.5/24", mac="00:00:00:00:00:08")
        ...
        net.addLink( r1, s2 ,bw=1)
        net.addLink( r1, s3 ,bw=1)
        ...
        h5.cmd("ip route add default via 10.0.2.1")
        ...
        s3.cmd("ovs-ofctl add-flow s3 priority=10,ip,nw_dst=10.0.2.0/24,actions=output:2")
